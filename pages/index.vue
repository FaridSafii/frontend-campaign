<template>
  <div class="landing-page">
      <section class="landing-hero pt-5 md:px-10 ">
        <div class="header__bg"></div>
        <div class="container mx-auto relative ">
          <Navbar />
          <div class="flex items-center pt-10 px-5 md:px-10">
            <div class="w-1/2">
      ...
      <section class="container mx-auto pt-24 md:px-10">
      ...
      <section class="container mx-auto pt-24 md:px-10">
        ...
        <div class="flex mt-3 -mx-6 2xl:place-content-center">
          <div
            class="card-project w-1/3 2xl:w-1/4 mx-6 my-4 p-5 border border-gray-500 rounded-20"
          >
            <div class="item">
