<template>
        ...
        <div class="w-auto md:w-2/4 lg:w-2/3 flex justify-center items-center">
          <div class="w-full lg:w-1/2 px-10 lg:px-0">
            ...
            <div class="mb-6">
              <div class="mb-4">
                <!-- JS yang akan mengarahkan tombol ke path yang diotuju -->
                <button
...
<script>
//layout -> folder layouts, auth -> nama file di folder layout
export default{
        layout: 'auth',
}
</script>
...
<style scoped>
 /* scoped merupakan fitur dimana style hanya dapat dijalankan di file ini saja */
.auth-background {
